...
We'll put a pin our type inference aspirations here. Our AST, Type, and type inference algorithm provide a strong foundation for our implementation. In our [next post](/posts/bidirectional-constraint-generation) we'll implement constraint generation using a bidirectional type system.
