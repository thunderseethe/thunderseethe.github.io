...
And of course, if you'd like to skip ahead you can find the full source code in [the companion repository](https://github.com/thunderseethe/type-inference-example/tree/main/base)
